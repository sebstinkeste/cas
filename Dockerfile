...
COPY deployerConfigContext.xml /usr/local/cas-3.5.3/cas-server-webapp/src/main/webapp/WEB-INF/deployerConfigContext.xml
RUN mvn install && \
    cp target/cas.war /usr/local/tomcat/webapps/cas.war
